...
/* Created at: Sun Oct 27 13:42:03 ART 2013 */
...
// ========
// File: /components/com_sobipro/var/js/tree_507074171fa073e1a61e86ec99e51a1c.js
// ========
 ...
 */
 // Created at Sun Oct 27 13:42:03 ART 2013 by Sobi Pro Component
...
var sobiCats_stmWait = 'http://localhost/UbicoArte/media/sobipro/styles/spinner.gif';

sobiCats_stmImgs[ 'root' ] = 'http://localhost/UbicoArte/media/sobipro/tree/base.gif';
sobiCats_stmImgs[ 'join' ] = 'http://localhost/UbicoArte/media/sobipro/tree/join.gif';
sobiCats_stmImgs[ 'joinBottom' ] = 'http://localhost/UbicoArte/media/sobipro/tree/joinbottom.gif';
sobiCats_stmImgs[ 'plus' ] = 'http://localhost/UbicoArte/media/sobipro/tree/plus.gif';
sobiCats_stmImgs[ 'plusBottom' ] = 'http://localhost/UbicoArte/media/sobipro/tree/plusbottom.gif';
sobiCats_stmImgs[ 'minus' ] = 'http://localhost/UbicoArte/media/sobipro/tree/minus.gif';
sobiCats_stmImgs[ 'minusBottom' ] = 'http://localhost/UbicoArte/media/sobipro/tree/minusbottom.gif';
sobiCats_stmImgs[ 'folder' ] = 'http://localhost/UbicoArte/media/sobipro/tree/folder.gif';
sobiCats_stmImgs[ 'disabled' ] = 'http://localhost/UbicoArte/media/sobipro/tree/disabled.gif';
sobiCats_stmImgs[ 'folderOpen' ] = 'http://localhost/UbicoArte/media/sobipro/tree/folderopen.gif';
sobiCats_stmImgs[ 'line' ] = 'http://localhost/UbicoArte/media/sobipro/tree/line.gif';
sobiCats_stmImgs[ 'empty' ] = 'http://localhost/UbicoArte/media/sobipro/tree/empty.gif';;
;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=20&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
...
// ========
// File: /components/com_sobipro/var/js/edit_7501c0c8f0e7a0faabbb1452f4eff9e6.js
// ========
...
function SP_selectCat( sid, add )
{
	...
	var request = new SobiPro.Json(
		"http://localhost/UbicoArte/index.php?option=com_sobipro&task=category.parents&out=json&format=raw&tmpl=component" + '&sid=' + sid,
		{
