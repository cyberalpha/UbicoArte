 ...
 */
 // Created at Wed Oct 30 18:53:46 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 20;
...
var menuTree_stmWait = 'http://localhost/Direccionarte/media/sobipro/styles/spinner.gif';

menuTree_stmImgs[ 'root' ] = 'http://localhost/Direccionarte/media/sobipro/tree/base.gif';
menuTree_stmImgs[ 'join' ] = 'http://localhost/Direccionarte/media/sobipro/tree/join.gif';
menuTree_stmImgs[ 'joinBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/joinbottom.gif';
menuTree_stmImgs[ 'plus' ] = 'http://localhost/Direccionarte/media/sobipro/tree/plus.gif';
menuTree_stmImgs[ 'plusBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/plusbottom.gif';
menuTree_stmImgs[ 'minus' ] = 'http://localhost/Direccionarte/media/sobipro/tree/minus.gif';
menuTree_stmImgs[ 'minusBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/minusbottom.gif';
menuTree_stmImgs[ 'folder' ] = 'http://localhost/Direccionarte/media/sobipro/tree/folder.gif';
menuTree_stmImgs[ 'disabled' ] = 'http://localhost/Direccionarte/media/sobipro/tree/disabled.gif';
menuTree_stmImgs[ 'folderOpen' ] = 'http://localhost/Direccionarte/media/sobipro/tree/folderopen.gif';
menuTree_stmImgs[ 'line' ] = 'http://localhost/Direccionarte/media/sobipro/tree/line.gif';
menuTree_stmImgs[ 'empty' ] = 'http://localhost/Direccionarte/media/sobipro/tree/empty.gif';;

menuTree_stmImgMatrix[ 8 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 9 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 10 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 11 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 12 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 13 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 14 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 15 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 16 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 17 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 18 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 19 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 20 ] = new Array( 'join' );;
//__PARENT_ARR__
