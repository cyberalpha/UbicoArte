...
/* Created at: Wed Oct 30 19:12:45 ART 2013 */
...
// ========
// File: /components/com_sobipro/lib/js/jquery.js
// ========
...
// ========
// File: /components/com_sobipro/usr/templates/default/js/edit.js
// ========
...
// ========
// File: /components/com_sobipro/usr/templates/default/js/osx.js
// ========
...
// ========
// File: /components/com_sobipro/var/js/tree_407a633e7880f04482aa5a7f72e8c0c9.js
// ========
 ...
 */
 // Created at Wed Oct 30 19:12:45 ART 2013 by Sobi Pro Component

var sobiCats_stmcid = 0;
var sobiCats_stmLastNode = 11;
...
var sobiCats_stmWait = 'http://localhost/Direccionarte/media/sobipro/styles/spinner.gif';

sobiCats_stmImgs[ 'root' ] = 'http://localhost/Direccionarte/media/sobipro/tree/base.gif';
sobiCats_stmImgs[ 'join' ] = 'http://localhost/Direccionarte/media/sobipro/tree/join.gif';
sobiCats_stmImgs[ 'joinBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/joinbottom.gif';
sobiCats_stmImgs[ 'plus' ] = 'http://localhost/Direccionarte/media/sobipro/tree/plus.gif';
sobiCats_stmImgs[ 'plusBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/plusbottom.gif';
sobiCats_stmImgs[ 'minus' ] = 'http://localhost/Direccionarte/media/sobipro/tree/minus.gif';
sobiCats_stmImgs[ 'minusBottom' ] = 'http://localhost/Direccionarte/media/sobipro/tree/minusbottom.gif';
sobiCats_stmImgs[ 'folder' ] = 'http://localhost/Direccionarte/media/sobipro/tree/folder.gif';
sobiCats_stmImgs[ 'disabled' ] = 'http://localhost/Direccionarte/media/sobipro/tree/disabled.gif';
sobiCats_stmImgs[ 'folderOpen' ] = 'http://localhost/Direccionarte/media/sobipro/tree/folderopen.gif';
sobiCats_stmImgs[ 'line' ] = 'http://localhost/Direccionarte/media/sobipro/tree/line.gif';
sobiCats_stmImgs[ 'empty' ] = 'http://localhost/Direccionarte/media/sobipro/tree/empty.gif';;

sobiCats_stmImgMatrix[ 12 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 15 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 16 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 17 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 14 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 18 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 10 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 20 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 9 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 8 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 19 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 13 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 11 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=1&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
...
// ========
// File: /components/com_sobipro/var/js/edit_bd88038d8962046841dffe139571136b.js
// ========
...
function SP_selectCat( sid, add )
{
	...
	var request = new SobiPro.Json(
		"http://localhost/Direccionarte/index.php?option=com_sobipro&task=category.parents&out=json&format=raw&tmpl=component" + '&sid=' + sid,
		{
